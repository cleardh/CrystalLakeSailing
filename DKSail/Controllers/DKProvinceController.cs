...
{
    public class DKProvinceController : Controller
    {
        private readonly SailContext _context;

        public DKProvinceController(SailContext context)
        {
            _context = context;
        }
