...
{
    public class DKCountryController : Controller
    {
        private readonly SailContext _context;

        public DKCountryController(SailContext context)
        {
            _context = context;
        }
        ...
        // GET: DKCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DKCountry/Create
